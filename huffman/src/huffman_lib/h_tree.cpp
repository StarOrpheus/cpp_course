...
void h_tree::__code_table_generator::operator()(uint32_t vertex) {
    tree_node const& cur_node = g[vertex];
...
h_tree::__code_table_generator::__code_table_generator(dynamic_bitset &buffer, vector<dynamic_bitset> &result,
                                                       const vector<h_tree::tree_node> &g)
...
h_tree::tree_node::tree_node() : left(devil_vertex),
                           right(devil_vertex),
                           weight(std::numeric_limits<uint32_t >::max()),
                           c(max_symbol) {}

h_tree::tree_node::tree_node(uint32_t left, uint32_t right, uint32_t weight, symbol c, bool terminal)
